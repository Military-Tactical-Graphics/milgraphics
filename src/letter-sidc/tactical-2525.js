...
export default function tacticalPoints(sidc, std2525) {
    ...
    sidc['G-G-GLP---'] = ms.geometryConverter["PHASE LINE"]; //TACGRP.C2GM.GNL.LNE.PHELNE
    ...
    sidc['G-G-AAR---'] = ms.geometryConverter["RESTRICTED OPERATIONS ZONE"]; //TACGRP.C2GM.AVN.ARS.ROZ
    ...
    sidc['G-F-ATG---'] = ms.geometryConverter["GROUP OF TARGETS"]; //TACGRP.FSUPP.ARS.ARATGT.SGTGT
